...
$cachedir = dirname(__FILE__) . '/cache';				// Путь к кэшу
$cssdir   = dirname(__FILE__) . '/templates/aohua/css';	// Путь к css файлам
$jsdir    = dirname(__FILE__) . '/templates/aohua/js';// Путь к js файлам
