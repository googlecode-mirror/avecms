...
{/if}
<div class="pageHeaderTitle" style="margin-top:-18px;">
  <div class="h_start">
    &nbsp;
  </div>
  <div class="HeaderTitle">
    <h2>{#MAIN_WELCOMETEXT#}</h2>
  </div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="5">
        ...
        <col width="50%">
        <tr>
          <td> {if check_permission('documents')}
            <div id="docsTasks">
            ...
            {/if} </td>
          <td> {if check_permission('rubrics')}
            <div id="rubsTasks">
        ...
        <tr>
          <td> {if check_permission('request')}
            <div id="queryTasks">
            ...
            {/if} </td>
          <td> {if check_permission('navigation')}
            <div id="naviTasks">
        ...
        <tr>
          <td> {if check_permission('template')}
            <div id="templTasks">
            ...
            {/if} </td>
          <td> {if check_permission('modules')}
            <div id="moduleTasks">
        ...
        <tr>
          <td> {if check_permission('gen_settings')}
            <div id="settTasks">
            ...
            {/if} </td>
          <td> {if check_permission('dbactions')}
            <div id="dbTasks">
        ...
        <tr>
          <td valign="top"> {* <!-- STATISTIC --> *}
            <div id="statbox">
              ...
              <div class="numeric">
                {$cnts.modules_0+$cnts.modules_1}
              </div>
              <br />
              <br />
              {if $cnts.modules_0}
              <div class="text">
                {#MAIN_STAT_MODULES_OFF#}
              </div>
              <div class="numeric">
                {$cnts.modules_0|default:0}
              </div>
              <br />
              <br />
              {/if}
              ...
              <div class="numeric">
                {$cnts.users_0+$cnts.users_1}
              </div>
              <br />
              <br />
              {if $cnts.users_0}
              <div class="text">
                {#MAIN_STAT_USERS_WAIT#}
              </div>
              <div class="numeric">
                {$cnts.users_0|default:0}
              </div>
              <br />
              <br />
              {/if}
          ...
          <td valign="top"> {* <!-- STATISTIC --> *}
            <div id="sysinfo">
              ...
              <br />
              <div id="cc" style="font-size:12px;">
                &raquo;&nbsp;{#MAIN_STAT_CLEAR_CACHE#}
              </div>
              <div class="ajax">
                <div id="loading" style="display:none">
                  <img src="{$tpl_dir}/js/jquery/images/ajax-loader-green.gif" border="0" />
                </div>
                <span id="ccc"></span>
              </div>
              <br />
              ...
              <div class="seesettings">
                <form style="clear:both; display:block; width:100%;">
                  <input name="templateCacheClear" type="checkbox" value="1" checked="checked">
                  <label class="cursor">{#MAIN_CLEAR_CACHE_TPL#}</label>
                  <input name="templateCompiledTemplateClear" type="checkbox" value="1" checked="checked">
                  <label class="cursor">{#MAIN_CLEAR_CACHE_PAGES#}</label>
                  <input name="moduleCacheClear" type="checkbox" value="1" checked="checked">
                  <label class="cursor">{#MAIN_CLEAR_CACHE_MOD#}</label>
                  <input name="sqlCacheClear" type="checkbox" value="1" checked="checked">
                  <label class="cursor">{#MAIN_CLEAR_CACHE_SQL#}</label>
                  <input name="sessionClear" type="checkbox" value="1">
