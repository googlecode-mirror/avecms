...
<form method="post" action="index.php" class="login">
	...
	<p>
		...
		<a class="tooltip" title="{#LOGIN_REMINDER_INFO#}" href="index.php?module=login&amp;action=passwordreminder">{#LOGIN_PASSWORD_REMIND#}</a>&nbsp;|&nbsp;
		{if $active == 1}
			<a class="tooltip" title="{#LOGIN_REGISTER_INFO#}" href="index.php?module=login&amp;action=register">{#LOGIN_NEW_REGISTER#}</a>
		{/if}
	</p>
</form>
