...
{/if}
	...
	<tr>
		...
		<td class="forum_post_second">
            <p>
				<input class="noborder" style="background-color:transparent; border:0px" type="checkbox" name="parseurl" value="1" checked="checked">{#ConvertUrls#}</input>
				<br />
            {if $ugroup!=2}
				<input class="noborder" style="background-color:transparent; border:0px" type="checkbox" name="notification" value="1" {if ( $notification==1 ) || ($smarty.request.notification==1) }checked="checked"{/if}>{#Notification#}</input>
				<br />
           	{/if}
				<input class="noborder" style="background-color:transparent; border:0px" type="checkbox" name="disablebb" value="1" {if $smarty.request.disablebb==1 }checked="checked"{/if}>{#DisableBBCode#}</input>
				<br />
				<input class="noborder" style="background-color:transparent; border:0px" type="checkbox" name="disablesmileys" value="1" {if $smarty.request.disablesmileys==1 }checked="checked"{/if}>{#DisableSmilies#}</input>
				<br />
            {if $ugroup!=2}
				<input class="noborder" style="background-color:transparent; border:0px" type="checkbox" name="usesig" value="1" checked="checked">{#ShowSig#}</input>
			{/if}
			</p>
        </td>
    </tr>
