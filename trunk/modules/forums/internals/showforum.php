...
//				$where_time_stat = " AND ((UNIX_TIMESTAMP(NOW()) / $divisor) - (UNIX_TIMESTAMP(p.datum) / $divisor)) <= $period";
			...
			$GLOBALS['AVE_Template']->assign("sort_by_author_link", "index.php?module=forums&amp;show=showforum&amp;fid=" . $fid . "&amp;sortby=UserName&amp;sort=$order");
