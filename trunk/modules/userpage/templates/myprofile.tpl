...
<div class="mod_userpage_border_myprofile">
		...
		<div class="mod_userpage_content">
			<table width="100%" border="0" cellpadding="4" cellspacing="1">
				<tr>
					...
					<td colspan="2" class="mod_userpage_second">{$smarty.session.user_id}</td>
				</tr>
				<tr>
			...
			{if $show_geschlecht==1}
				<tr>
					...
					<td class="mod_userpage_second">
						...
						<label><input type="radio" name="Geschlecht" value="female" {if $r.Geschlecht=='female'}checked{/if}>{#Female#}</label>
					</td>
				</tr>
			{/if}
			</table>
		...
		<div class="mod_userpage_content">
			...
			{if $show_interessen==1}
				<tr>
					...
					<td class="mod_userpage_second">
						<textarea name="Interessen" cols="38" rows="5" id="Interessen">{$r.Interessen|stripslashes}</textarea>
					</td>
				</tr>
			{/if}
			{if $show_signatur==1}
