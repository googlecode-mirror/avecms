...
if (defined('ACP'))
{
    ...
    $modul['description'] = 'Данный модуль предназначен для организации системы комментариев для документов на сайте. Для того, чтобы использовать данный модуль, разместите системный тег <strong>[mod_comment]</strong> в нужном месте шаблона рубрики.';
    ...
    $modul['ModulFunktion'] = 'mod_comment'; // Название функции, на которую будет заменен системный тег
