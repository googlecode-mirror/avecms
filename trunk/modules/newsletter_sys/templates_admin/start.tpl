	...
	<table width="100%" border="0" cellpadding="8" cellspacing="1" class="tableborder">
		...
		{foreach from=$items item=nl}
			<tr style="background-color:#eff3eb;" onmouseover="this.style.backgroundColor='#dae0d8';" onmouseout="this.style.backgroundColor='#eff3eb';" id="table_rows">
				...
				<td align="center"><input onclick="window.open('index.php?id={$nl->id}&do=modules&action=modedit&module=newsletter_sys&moduleaction=shownewsletter&cp={$sess}&pop=1&format={$nl->format}','showtext','top=0,left=0,scrollbars=1,width=800,height=750')" type="button" class="button" value="{#SNL_SEND_SHOW#}" /></td>
