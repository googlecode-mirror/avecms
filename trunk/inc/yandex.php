 ...
 * @todo
 * <pre>
 * добавить в настройки выбор срока доставки означающий "самовывоз" дл€ delivery
 * добавить в настройки выбор доставки дл€ определени€ стоимости локальной доставки - local_delivery_cost
 * добавить в карточку товара поле страны происхождени€ - country_of_origin
...
// обща€ информаци€ о магазине и валюты
$sql = mysql_query("
	SELECT
		Aktiv,
		Waehrung,
