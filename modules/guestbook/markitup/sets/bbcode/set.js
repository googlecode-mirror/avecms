...
//  previewInWindow: 'width=640, height=480, resizable=yes, scrollbars=yes',
  markupSet: [
      ...
      {name:'Smile', replaceWith:':)', dropMenu: [
        {name:'Happy',     replaceWith:':D', className:"happy" },
        {name:'Surprised', replaceWith:':o', className:"surprised" },
        {name:'Tongue',    replaceWith:':p', className:"tongue" },
        {name:'Unhappy',   replaceWith:':(', className:"unhappy" },
