...
//			if (empty($_POST['OrderPhone'])) array_push($errors, $GLOBALS['mod']['config_vars']['Errors_NoOrderPhone']);
			...
			if (isset($_POST['billing_firstname'])) $_SESSION['billing_firstname'] = stripslashes($_POST['billing_firstname']);
			if (isset($_POST['billing_lastname'])) $_SESSION['billing_lastname'] = stripslashes($_POST['billing_lastname']);
			if (isset($_POST['billing_street'])) $_SESSION['billing_street'] = stripslashes($_POST['billing_street']);
			if (isset($_POST['billing_streetnumber'])) $_SESSION['billing_streetnumber'] = stripslashes($_POST['billing_streetnumber']);
			if (isset($_POST['billing_zip'])) $_SESSION['billing_zip'] = stripslashes($_POST['billing_zip']);
			if (isset($_POST['billing_town'])) $_SESSION['billing_town'] = stripslashes($_POST['billing_town']);
			if (isset($_POST['country'])) $_SESSION['billing_country'] = stripslashes($_POST['country']);
			...
			if (isset($_POST['shipping_firstname'])) $_SESSION['shipping_firstname'] = stripslashes($_POST['shipping_firstname']);
			if (isset($_POST['shipping_lastname'])) $_SESSION['shipping_lastname'] = stripslashes($_POST['shipping_lastname']);
			if (isset($_POST['shipping_street'])) $_SESSION['shipping_street'] = stripslashes($_POST['shipping_street']);
			if (isset($_POST['shipping_streetnumber'])) $_SESSION['shipping_streetnumber'] = stripslashes($_POST['shipping_streetnumber']);
